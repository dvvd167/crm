...
/** --------------------------------------------------------------------------------
 * This classes renders the [accept estimate] email and stores it in the queue
...
class AcceptEstimate extends Mailable {
    use Queueable;
    ...
    public function build() {
        ...
        //email template
        if (!$template = \App\Models\EmailTemplate::Where('emailtemplate_name', 'Estimate Accepted')->first()) {
            return false;
        }

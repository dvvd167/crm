...
class PaymentConfirmation extends Mailable {
    ...
    public function build() {
        ...
        //email template
        if (!$template = \App\Models\Landlord\EmailTemplate::on('landlord')->Where('emailtemplate_name', 'Payment Confirmation')->first()) {
            return false;
        }

        //validate
        if (!$this->obj instanceof \App\Models\Landlord\Payment || !$this->customer instanceof \App\Models\Landlord\Tenant) {
            return false;
        }

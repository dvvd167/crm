...
/** --------------------------------------------------------------------------------
 * This classes renders the [task comment] email and stores it in the queue
...
class TaskComment extends Mailable {
    ...
    public function build() {
        ...
        //email template
        if (!$template = \App\Models\EmailTemplate::Where('emailtemplate_name', 'Task Comment')->first()) {
            return false;
        }

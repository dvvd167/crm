...
/** --------------------------------------------------------------------------------
 * This classes renders the [lead comment] email and stores it in the queue
...
class LeadComment extends Mailable {
    use Queueable;
    ...
    public function build() {
        ...
        //email template
        if (!$template = \App\Models\EmailTemplate::Where('emailtemplate_name', 'Lead Comment')->first()) {
            return false;
        }

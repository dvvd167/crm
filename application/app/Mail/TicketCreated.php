...
/** --------------------------------------------------------------------------------
 * This classes renders the [ticket created] email and stores it in the queue
...
class TicketCreated extends Mailable {
    ...
    public function build() {
        ...
        //email template
        if (!$template = \App\Models\EmailTemplate::Where('emailtemplate_name', 'New Ticket')->first()) {
            return false;
        }

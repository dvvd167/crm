...
/** --------------------------------------------------------------------------------
 * This classes renders the [publish estimate] email and stores it in the queue
...
class PublishEstimate extends Mailable {
    use Queueable;
    ...
    public function build() {
        ...
        //email template
        if (!$template = \App\Models\EmailTemplate::Where('emailtemplate_name', 'New Estimate')->first()) {
            return false;
        }

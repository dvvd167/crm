...
class LeadNewSubmission extends Mailable {
    use Queueable;
    ...
    public function build() {
        ...
        //email template
        if (!$template = \App\Models\EmailTemplate::Where('emailtemplate_name', 'New Lead Form Submission')->first()) {
            return false;
        }
        ...
        $payload += [
            ...
            'lead_form_name' => $this->data['lead_form_name'],
            'lead_url' => url('/leads'),
        ];

...
class SubscriptionRenewed extends Mailable {
    ...
    public function build() {
        ...
        //email template - by user type
        if (!$template = \App\Models\EmailTemplate::Where('emailtemplate_name', 'SubscriptionRenewed')->where('emailtemplate_type', $this->user->type)->first()) {

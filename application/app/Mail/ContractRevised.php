...
class ContractRevised extends Mailable {
    use Queueable;
    ...
    public function build() {
        ...
        //email template
        if (!$template = \App\Models\EmailTemplate::Where('emailtemplate_name', 'Contract Revised')->first()) {
            return false;
        }

        //validate
        if (!$this->obj instanceof \App\Models\Contract || !$this->user instanceof \App\Models\User) {
            return false;
        }
        ...
        $payload += [
            ...
            'contract_id' => runtimeContractIdFormat($this->obj->doc_id),
            'contract_title' => $this->obj->doc_title,
            'contract_value' => runtimeMoneyFormat($this->obj->contract_value),
            'contract_start_date' => runtimeDate($this->obj->doc_date_start),
            'contract_end_date' => runtimeDate($this->obj->doc_date_end),
            'contract_url' => url('/contracts/view/'.$this->obj->doc_unique_id),
        ];

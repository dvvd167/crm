...
class SubscriptionStarted extends Mailable {
    ...
    public function build() {
        ...
        //email template
        if (!$template = \App\Models\EmailTemplate::Where('emailtemplate_name', 'Subscription Started')
            ->where('emailtemplate_type', $this->user->type)
            ->first()) {
        ...
        $payload += [
            ...
            'subscription_status' => runtimeLang($this->obj->subscription_status),
            'subscription_amount' => runtimeMoneyFormat($this->obj->subscription_final_amount) . '/' . subscriptionFormatRenewalInterval($this->obj->subscription_gateway_interval, $this->obj->subscription_gateway_period),
            ...
            'subscription_cycle' => subscriptionFormatRenewalInterval($this->obj->subscription_gateway_interval, $this->obj->subscription_gateway_period),
        ];

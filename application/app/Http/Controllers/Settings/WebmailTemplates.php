...
class WebmailTemplates extends Controller {
    ...
    private function pageSettings($section = '', $data = []) {
        ...
        $page += [
            ...
            'add_modal_create_url' => url('settings/webmail/templates/create?filter_type=' . request('filter_type')),
            'add_modal_action_url' => url('settings/webmail/templates?filter_type=' . request('filter_type')),

...
class Pricing extends Controller {
    ...
    public function edit() {
        ...
        //get section
        $section = \App\Models\Landlord\Frontend::Where('frontend_name', 'page-pricing')->first();

        return view('landlord/frontend/pricing/page', compact('page', 'section'))->render();
    ...
    public function update(FileRepository $filerepo) {
        ...
        $messages = [
            ...
            'frontend_data_4.required' => __('lang.button_text') . ' - ' . __('lang.is_required'),
        ];
        ...
        $jsondata['redirect_url'] = url('app-admin/frontend/pricing');

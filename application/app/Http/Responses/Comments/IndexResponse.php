...
/** --------------------------------------------------------------------------------
 * This classes renders the response for the [index] process for the comments
 * controller
...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'search':
                $template = 'pages/comments/components/wrapper';
                $dom_container = '#comments-table-wrapper';
                $dom_action = 'replace';
                break;
            ...
            if ($comments->currentPage() < $comments->lastPage()) {
                $url = loadMoreButtonUrl($comments->currentPage() + 1, request('source'));
            ...
            $jsondata['dom_html'][] = [
                ...
                'action' => 'replace',
                'value' => strtoupper(__('lang.comments')),
            ];

...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'landlord/offlinepayments/table/ajax';
            ...
            case 'search':
                $template = 'landlord/offlinepayments/table/table';
            ...
            return view('landlord/offlinepayments/wrapper', compact('page', 'payments'))->render();
        }

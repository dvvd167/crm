...
namespace App\Http\Responses\Landlord\OfflinePayments;
...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'landlord/payments/table/ajax';
            ...
            case 'search':
                $template = 'landlord/payments/table/table';
            ...
            default:
                ...
                $jsondata['dom_visibility'][] = [
                    'selector' => '#list-page-actions-container-payments',
                    'action' => 'show',
                ];
                break;
            }
            ...
            $jsondata['dom_html'][] = [
                ...
                'action' => 'replace',
                'value' => strtoupper(__('lang.payments')),
            ];
            ...
            return view('landlord/payments/wrapper', compact('page', 'payments'))->render();
        }

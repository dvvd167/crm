...
class ListResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/projects/views/list/table/ajax';
            ...
            case 'search':
                $template = 'pages/projects/views/list/table/table';
            ...
            $html = view($template, compact('page', 'projects', 'stats', 'categories', 'tags', 'fields'))->render();
            ...
            return view('pages/projects/views/list/wrapper', compact('page', 'projects', 'stats', 'categories', 'tags', 'fields'))->render();
        }

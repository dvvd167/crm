...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/projects/components/table/ajax';
            ...
            case 'search':
                $template = 'pages/projects/components/table/table';
            ...
            default:
                $template = 'pages/projects/tabswrapper';
            ...
            return view('pages/projects/wrapper', compact('page', 'projects', 'stats', 'categories', 'tags'))->render();
        }

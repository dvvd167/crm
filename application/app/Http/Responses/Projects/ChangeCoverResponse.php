...
class ChangeCoverResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        $jsondata['dom_attributes'][] = [
            'selector' => '#project-cover-image',
            'attr' => 'src',
            'value' => url('storage/files/' . $project->project_cover_directory . '/' . $project->project_cover_filename),
        ];
        $jsondata['dom_visibility'][] = [

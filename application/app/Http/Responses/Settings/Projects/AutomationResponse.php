...
class AutomationResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        $html = view('pages/settings/sections/projects/automation', compact('page', 'settings', 'taxrates'))->render();
        ...
        if (request('url_type') == 'dynamic') {
            ...
            $jsondata['dom_classes'][] = [
                'selector' => '#settings-menu-projects-automation',
                'action' => 'add',
                'value' => 'active',
            ];
        }
        ...
        $jsondata['postrun_functions'][] = [
            'value' => 'NXSettingsProjectsAutomation',
        ];

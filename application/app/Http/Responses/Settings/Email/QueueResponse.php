...
class QueueResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        case 'load':
            $template = 'pages/settings/sections/email/queue/ajax';
        ...
        case 'search':
            $template = 'pages/settings/sections/email/queue/table';
        ...
        $jsondata['dom_html'][] = [
            ...
            'action' => 'replace',
            'value' => strtoupper(__('lang.email_queue')),
        ];
        ...
        if (request('url_type') == 'dynamic') {
            ...
            $jsondata['dom_classes'][] = [
                'selector' => '#settings-menu-email-queue',
                'action' => 'add',
                'value' => 'active',
            ];
        }

...
class FoldersResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        $html = view('pages/settings/sections/files/folders', compact('page', 'settings'))->render();
        ...
        if (request('url_type') == 'dynamic') {
            ...
            $jsondata['dom_classes'][] = [
                'selector' => '#settings-menu-files-folders',
                'action' => 'add',
                'value' => 'active',
            ];
        }

...
class PaymentsResponse implements Responsable {
    ...
    /**
     * render the view for payments members
     *
    ...
    public function toResponse($request) {
        ...
        //was this call made from an embedded page/ajax or directly on payments page
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'account/payments/table/ajax';
            ...
            case 'search':
                $template = 'account/payments/table/table';
            ...
            default:
                $template = 'account/payments/wrapper';
                $dom_container = '#settings-wrapper';
                $dom_action = 'replace';
                break;
            }
            ...
            $html = view($template, compact('page', 'payments'))->render();
            ...
            $jsondata['dom_html'][] = [
                ...
                'action' => 'replace',
                'value' => strtoupper(__('lang.payment_history')),
            ];
            ...
            if (request('url_type') == 'dynamic') {
                ...
                $jsondata['dom_classes'][] = [
                    'selector' => '#settings-menu-billing-payments',
                    'action' => 'add',
                    'value' => 'active',
                ];
            }
            ...
            return view('account/payments/wrapper', compact('page', 'payments'))->render();
        }

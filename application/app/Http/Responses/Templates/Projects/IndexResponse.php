...
/** --------------------------------------------------------------------------------
 * This classes renders the response for the [index] process for the project
 * controller
...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //was this call made from an embedded page/ajax or directly on project page
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'search':
                ...
                $dom_container = '#projects-table-wrapper';
            ...
            $jsondata['dom_html'][] = [
                ...
                'action' => 'replace',
                'value' => strtoupper(__('lang.project')),
            ];
            ...
            $page['loading_target'] = 'project-td-container';

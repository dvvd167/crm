...
/** --------------------------------------------------------------------------------
 * This classes renders the response for the [index] process for the proposal
 * controller
...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/templates/proposals/components/table/ajax';
            ...
            case 'search':
                $template = 'pages/templates/proposals/components/table/table';
            ...
            default:
                $template = 'pages/templates/proposals/tabswrapper';
            ...
            return view('pages/templates/proposals/wrapper', compact('page', 'templates'))->render();
        }

    ...
    public function toResponse($request) {
        ...
        if (request('action') == 'load' || request('action') == 'sort') {
            ...
            if (request('action') == 'load') {
                $html = view('pages/reports/projects/category/table', compact('projects', 'totals'))->render();
                $jsondata['dom_html'][] = [
            ...
            if (request('action') == 'sort') {
                $html = view('pages/reports/projects/category/ajax', compact('projects', 'totals'))->render();
                $jsondata['dom_html'][] = [
            ...
            $html = view('pages/reports/projects/category/wrapper', compact('projects', 'totals'))->render();
            $jsondata['dom_html'][] = [

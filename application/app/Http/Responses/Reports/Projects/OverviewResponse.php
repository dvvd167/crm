    ...
    public function toResponse($request) {
        ...
        if (request('action') == 'load' || request('action') == 'sort') {
            ...
            if (request('action') == 'load') {
                $html = view('pages/reports/projects/overview/table', compact('projects', 'totals'))->render();
                $jsondata['dom_html'][] = [
            ...
            if (request('action') == 'sort') {
                $html = view('pages/reports/projects/overview/ajax', compact('projects', 'totals'))->render();
                $jsondata['dom_html'][] = [
            ...
            $html = view('pages/reports/projects/overview/wrapper', compact('projects', 'totals'))->render();
            $jsondata['dom_html'][] = [

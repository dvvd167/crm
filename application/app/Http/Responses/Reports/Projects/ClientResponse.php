    ...
    public function toResponse($request) {
        ...
        if (request('action') == 'load' || request('action') == 'sort') {
            ...
            if (request('action') == 'load') {
                $html = view('pages/reports/projects/client/table', compact('projects', 'totals'))->render();
                $jsondata['dom_html'][] = [
            ...
            if (request('action') == 'sort') {
                $html = view('pages/reports/projects/client/ajax', compact('projects', 'totals'))->render();
                $jsondata['dom_html'][] = [
            ...
            $html = view('pages/reports/projects/client/wrapper', compact('projects', 'totals'))->render();
            $jsondata['dom_html'][] = [
        ...
        $jsondata['dom_classes'][] = [
            'selector' => '#reports_tabs_projects',
            'action' => 'add',
            'value' => 'active',
        ];

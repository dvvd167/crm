    ...
    public function toResponse($request) {
        ...
        if (request('action') == 'load' || request('action') == 'sort') {
            ...
            if (request('action') == 'load') {
                $html = view('pages/reports/estimates/category/table', compact('estimates', 'totals'))->render();
                $jsondata['dom_html'][] = [
            ...
            if (request('action') == 'sort') {
                $html = view('pages/reports/estimates/category/ajax', compact('estimates', 'totals'))->render();
                $jsondata['dom_html'][] = [
            ...
            $html = view('pages/reports/estimates/category/wrapper', compact('estimates', 'totals'))->render();
            $jsondata['dom_html'][] = [

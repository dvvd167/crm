    ...
    public function toResponse($request) {
        ...
        if (request('action') == 'load' || request('action') == 'sort') {
            ...
            if (request('action') == 'load') {
                $html = view('pages/reports/estimates/month/table', compact('estimates', 'totals', 'years'))->render();
                $jsondata['dom_html'][] = [
            ...
            if (request('action') == 'sort') {
                $html = view('pages/reports/estimates/month/ajax', compact('estimates', 'totals', 'years'))->render();
                $jsondata['dom_html'][] = [
            ...
            $html = view('pages/reports/estimates/month/wrapper', compact('estimates', 'totals', 'years'))->render();
            $jsondata['dom_html'][] = [

    ...
    public function toResponse($request) {
        ...
        if (request('action') == 'load' || request('action') == 'sort') {
            ...
            if (request('action') == 'load') {
                $html = view('pages/reports/invoices/month/table', compact('invoices', 'totals', 'years'))->render();
                $jsondata['dom_html'][] = [
            ...
            if (request('action') == 'sort') {
                $html = view('pages/reports/invoices/month/ajax', compact('invoices', 'totals', 'years'))->render();
                $jsondata['dom_html'][] = [
            ...
            $html = view('pages/reports/invoices/month/wrapper', compact('invoices', 'totals', 'years'))->render();
            $jsondata['dom_html'][] = [

    ...
    public function toResponse($request) {
        ...
        if (request('action') == 'load' || request('action') == 'sort') {
            ...
            if (request('action') == 'load') {
                $html = view('pages/reports/invoices/project/table', compact('invoices', 'totals'))->render();
                $jsondata['dom_html'][] = [
            ...
            if (request('action') == 'sort') {
                $html = view('pages/reports/invoices/project/ajax', compact('invoices', 'totals'))->render();
                $jsondata['dom_html'][] = [
            ...
            $html = view('pages/reports/invoices/project/wrapper', compact('invoices', 'totals'))->render();
            $jsondata['dom_html'][] = [

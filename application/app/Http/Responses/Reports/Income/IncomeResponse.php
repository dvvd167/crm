...
namespace App\Http\Responses\Reports\Income;
use Illuminate\Contracts\Support\Responsable;

class IncomeResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('action') == 'load' || request('action') == 'sort') {
            ...
            if (request('action') == 'load') {
                $html = view('pages/reports/income/table', compact('report'))->render();
                $jsondata['dom_html'][] = [
            ...
            if (request('action') == 'sort') {
                $html = view('pages/reports/income/ajax', compact('report'))->render();
                $jsondata['dom_html'][] = [
            ...
            $html = view('pages/reports/income/wrapper', compact('report'))->render();
            $jsondata['dom_html'][] = [

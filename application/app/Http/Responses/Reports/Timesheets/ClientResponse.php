    ...
    public function toResponse($request) {
        ...
        if (request('action') == 'load' || request('action') == 'sort') {
            ...
            if (request('action') == 'load') {
                $html = view('pages/reports/timesheets/client/table', compact('timesheets', 'totals'))->render();
                $jsondata['dom_html'][] = [
            ...
            if (request('action') == 'sort') {
                $html = view('pages/reports/timesheets/client/ajax', compact('timesheets', 'totals'))->render();
                $jsondata['dom_html'][] = [

    ...
    public function toResponse($request) {
        ...
        if (request('action') == 'load' || request('action') == 'sort') {
            ...
            if (request('action') == 'load') {
                $html = view('pages/reports/timesheets/project/table', compact('timesheets', 'totals'))->render();
                $jsondata['dom_html'][] = [
            ...
            if (request('action') == 'sort') {
                $html = view('pages/reports/timesheets/project/ajax', compact('timesheets', 'totals'))->render();
                $jsondata['dom_html'][] = [
            ...
            $html = view('pages/reports/timesheets/project/wrapper', compact('timesheets', 'totals'))->render();
            $jsondata['dom_html'][] = [

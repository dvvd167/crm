...
<form class="form" id="settingsFormGeneral">
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_purchase_code"
                name="settings_purchase_code" value="{{ $settings->settings_purchase_code ?? '' }}">
        </div>
    </div>
    @endif
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label text-left">{{ cleanLang(__('lang.timezone')) }}</label>
        <div class="col-12">
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_date_format"
                ...
                <option value="d-m-Y" {{ runtimePreselected('d-m-Y', $settings->settings_system_date_format ?? '') }}>
                    d-m-Y</option>
                <option value="d/m/Y" {{ runtimePreselected('d/m/Y', $settings->settings_system_date_format ?? '') }}>
                    d/m/Y</option>
                <option value="d.m.Y" {{ runtimePreselected('d.m.Y', $settings->settings_system_date_format ?? '') }}>
                    d.m.Y</option>
                <option value="m-d-Y" {{ runtimePreselected('m-d-Y', $settings->settings_system_date_format ?? '') }}>
                    m-d-Y</option>
                <option value="m/d/Y" {{ runtimePreselected('m/d/Y', $settings->settings_system_date_format ?? '') }}>
                    m/d/Y</option>
                <option value="m.d.Y" {{ runtimePreselected('m.d.Y', $settings->settings_system_date_format ?? '') }}>
                    m.d.Y</option>
                <option value="Y-m-d" {{ runtimePreselected('Y-m-d', $settings->settings_system_date_format ?? '') }}>
                    Y-m-d</option>
                <option value="Y/m/d" {{ runtimePreselected('Y/m/d', $settings->settings_system_date_format ?? '') }}>
                    Y/m/d</option>
                <option value="Y.m.d" {{ runtimePreselected('Y.m.d', $settings->settings_system_date_format ?? '') }}>
                    Y.m.d</option>
                <option value="Y-d-m" {{ runtimePreselected('Y-d-m', $settings->settings_system_date_format ?? '') }}>
                    Y-d-m</option>
                <option value="Y/d/m" {{ runtimePreselected('Y/d/m', $settings->settings_system_date_format ?? '') }}>
                    Y/d/m</option>
                <option value="Y.d.m" {{ runtimePreselected('Y.d.m', $settings->settings_system_date_format ?? '') }}>
    ...
    <!--pagination - limits-->
    <div class="form-group row">
        <label class="col-12 control-label col-form-label">{{ cleanLang(__('lang.table_pagination_limits')) }}</label>
        <div class="col-12">
            <input type="number" class="form-control form-control-sm" id="settings_system_pagination_limits"
                name="settings_system_pagination_limits" value="{{ $settings->settings_system_pagination_limits }}">
        </div>
    </div>

    <!--pagination - limits-->
    <div class="form-group row">
        <label class="col-12 control-label col-form-label">{{ cleanLang(__('lang.kanban_pagination_limits')) }}</label>
        <div class="col-12">
            <input type="number" class="form-control form-control-sm" id="settings_system_kanban_pagination_limits"
                ...
                value="{{ $settings->settings_system_kanban_pagination_limits }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label text-left">{{ cleanLang(__('lang.close_modal_windows_on_page_click')) }}</label>
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_close_modals_body_click"
                ...
                <option value="yes"
                    {{ runtimePreselected('yes', $settings->settings_system_close_modals_body_click ?? '') }}>
                    {{ cleanLang(__('lang.yes')) }}</option>
                <option value="no"
                    {{ runtimePreselected('no', $settings->settings_system_close_modals_body_click ?? '') }}>
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label text-left">{{ cleanLang(__('lang.session_timeout_popup')) }}</label>
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_session_login_popup"
                ...
                <option value="enabled"
                    {{ runtimePreselected('enabled', $settings->settings_system_session_login_popup ?? '') }}>
                    {{ cleanLang(__('lang.enabled')) }}</option>
                <option value="disabled"
                    {{ runtimePreselected('disabled', $settings->settings_system_session_login_popup ?? '') }}>
                    {{ cleanLang(__('lang.disabled')) }}</option>
            </select>
        </div>
    </div>
    ...
    <div class="form-group row">
        <label for="example-month-input"
            class="col-12 col-form-label text-left">{{ cleanLang(__('lang.default_language')) }}</label>
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_language_default"
                ...
                <option value="{{ $language }}"
                    {{ runtimePreselected($language, $settings->settings_system_language_default ?? '') }}>
                    {{ ucwords($language) }}</option>
                @endforeach
            </select>
        </div>
    </div>
